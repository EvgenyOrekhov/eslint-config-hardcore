...
The most strict (but practical) ESLint config out there. 649 rules.
...
| [eslint-plugin-putout](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout)    |            74 |
...
| **Total: `hardcore` + `hardcore/fp`**                               |       **586** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node`**                |       **621** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node` + `hardcore/ts-for-js`**                        |       **649** |
