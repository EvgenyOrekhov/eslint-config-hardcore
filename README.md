...
The most strict (but practical) ESLint config out there. 640 rules.
...
| **Total: `hardcore` + `hardcore/fp`**                               |       **577** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node`**                |       **612** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node` + `hardcore/ts-for-js`**                        |       **640** |
