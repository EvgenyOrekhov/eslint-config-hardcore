...
The most strict (but practical) framework-agnostic ESLint config out there. 654 rules.
...
| [eslint-plugin-regexp](https://github.com/ota-meshi/eslint-plugin-regexp)                                 |            39 |
...
| **Total: `hardcore` + `hardcore/fp`**                               |       **591** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node`**                |       **626** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node` + `hardcore/ts-for-js`**                        |       **654** |
