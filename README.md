...
| [eslint-plugin-regexp](https://github.com/ota-meshi/eslint-plugin-regexp)                                 |            17 |
...
| **Total: `hardcore` + `hardcore/fp`**                               |       **562** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node`**                |       **597** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node` + `hardcore/ts-for-js`**                        |       **625** |
