...
The most strict (but practical) ESLint config out there. 650 rules.
...
| **Total: `hardcore` + `hardcore/fp`**                               |       **587** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node`**                |       **622** |
...
| **Total: `hardcore` + `hardcore/fp` + `hardcore/node` + `hardcore/ts-for-js`**                        |       **650** |
